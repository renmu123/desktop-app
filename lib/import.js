...
var File = require(path.resolve(appPath, 'file'));
var Note = require(path.resolve(appPath, 'note'));
var Web = require(path.resolve(appPath, 'web'));
var Tag = require(path.resolve(appPath, 'tag'));
var async = require(path.resolve(appPath, 'async'));
var path = require(path.resolve(appPath, 'path'));
